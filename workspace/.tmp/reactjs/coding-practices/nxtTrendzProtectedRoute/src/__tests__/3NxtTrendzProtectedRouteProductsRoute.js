...
describe(':::RJSCPGXAYP_TEST_SUITE_3:::Products Route tests', () => {
  it(':::RJSCPGXAYP_TEST_38:::When the "/products" is provided in the URL by an unauthenticated user then the page should be redirected to LoginRoute and consists of an HTML image element with the given login image URL as src and alt text as "website login":::5:::', () => {
    mockGetCookie(false)
  ...
  it(':::RJSCPGXAYP_TEST_39:::ProductsRoute should consist of an HTML image element with the given image URL as src and alt text as "products":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productsRoutePath})
