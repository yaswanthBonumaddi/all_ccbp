...
describe(':::RJSCPGXAYP_TEST_SUITE_5:::Not Found Route tests', () => {
  it(':::RJSCPGXAYP_TEST_42:::When the "/bad-path" is provided in the URL then the page should be navigated to NotFoundRoute and consist of an HTML image element with the given not found image URL as src and alt text as "not found":::5:::', async () => {
