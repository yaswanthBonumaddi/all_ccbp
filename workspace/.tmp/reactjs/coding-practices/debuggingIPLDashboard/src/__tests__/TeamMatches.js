...
describe(':::RJSCPNE8JJ_TEST_SUITE_2:::Team Matches Route tests', () => {
  ...
  it(':::RJSCPNE8JJ_TEST_13:::When the Team Matches Route is opened, it should initially contain an HTML container element with data-testid attribute value as "loader":::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
