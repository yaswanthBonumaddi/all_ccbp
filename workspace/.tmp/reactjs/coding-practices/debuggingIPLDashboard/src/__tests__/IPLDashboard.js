...
describe(':::RJSCPNE8JJ_TEST_SUITE_1:::Home Route tests', () => {
  ...
  it(':::RJSCPNE8JJ_TEST_4:::When the Home Route is opened, it should initially consist of an HTML container element with data-testid attribute value as "loader":::5:::', async () => {
    renderWithBrowserRouter()
