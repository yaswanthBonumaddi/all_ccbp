...
describe(':::RJSCP809S4_TEST_SUITE_4:::Home Route tests', () => {
  beforeAll(() => {
    server.listen()
  })
  ...
  it(':::RJSCP809S4_TEST_34:::When "/" is provided in the URL by an unauthenticated user, then the page should be navigated to Login Route and consists of an HTML image element with alt attribute value as "website login" and src as given login image url:::5:::', () => {
    mockGetCookie(false)
  ...
  it(':::RJSCP809S4_TEST_35:::When "/" is provided in the URL by an authenticated user, then the page should be navigated to Home Route and consists of an HTML image element with alt as "clothes that get you noticed" and src as given home image URL:::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: homeRoutePath})
  ...
  it(':::RJSCP809S4_TEST_36:::When the Products link is clicked then the page should be navigated to Products Route and consist of an HTML main heading element with text content as "Category":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: homeRoutePath})
  ...
  it(':::RJSCP809S4_TEST_37:::When the Cart link is clicked, then the page should be navigated to Cart Route and consist of an HTML image element with alt as "cart" and src as given cart image URL:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: homeRoutePath})
  ...
  it(':::RJSCP809S4_TEST_38:::When the logout button is clicked, then the Cookies.remove() method should be called with the argument as "jwt_token":::5:::', () => {
    mockRemoveCookie()
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: homeRoutePath})
  ...
  it(':::RJSCP809S4_TEST_39:::When the logout button is clicked then the history.replace() method should be called with the argument "/login":::5:::', async () => {
    mockRemoveCookie()
    mockGetCookie()
  ...
  it(':::RJSCP809S4_TEST_40:::When the logout button is clicked then the page should be navigated to LoginRoute and consists of an HTML image element with alt attribute value as "website login" and src as given login image url:::5:::', async () => {
    mockGetCookie()
    mockRemoveCookie()
    renderWithBrowserRouter(<App />, {route: homeRoutePath})
    const logoutBtns = screen.getAllByRole('button', {
