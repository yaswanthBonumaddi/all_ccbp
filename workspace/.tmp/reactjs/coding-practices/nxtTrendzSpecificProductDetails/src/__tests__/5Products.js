...
describe(':::RJSCP809S4_TEST_SUITE_5:::Products Route tests', () => {
  beforeAll(() => {
    server.listen()
  })
  ...
  it(':::RJSCP809S4_TEST_41:::When "/products" is provided as the URL by an unauthenticated user, then the page should be navigated to Login Route and consists of an HTML image element with alt attribute value as "website login" and src as given login image url:::5:::', async () => {
    mockGetCookie(false)
  ...
  it(':::RJSCP809S4_TEST_42:::Products Route should consist of an HTML input element with type attribute value as "search":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productsRoutePath})
  ...
  it(':::RJSCP809S4_TEST_43:::Products Route should consist of an HTML paragraph elements with text content as the value of the key "name" in each item from the categoryOptions provided:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productsRoutePath})
  ...
  it(':::RJSCP809S4_TEST_44:::Products Route should consist of HTML image elements with alt attribute value as "rating {ratingId}" and src as the value of key "imageUrl" of each item in ratingsList provided:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productsRoutePath})
    expect(
      await screen.findByText(productsResponse.products[0].title, {
  ...
  it(':::RJSCP809S4_TEST_45:::Products Route should consist of HTML button element with text content as "Clear Filters":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productsRoutePath})
    expect(
      await screen.findByText(productsResponse.products[0].title, {
  ...
  it(':::RJSCP809S4_TEST_46:::When Products Route is opened, an HTTP GET request should be made to productsApiUrl with query parameters "title_search", "category", and "rating" with initial values as empty strings:::5:::', async () => {
    mockGetCookie()
  ...
  it(':::RJSCP809S4_TEST_47:::When the HTTP GET request in the Products Route is successful, then the page should consist of the HTML main heading elements with text content as the value of the key "title" in each item from the productsResponse:::5:::', async () => {
    mockGetCookie()
  ...
  it(':::RJSCP809S4_TEST_48:::When a non-empty value is provided in an HTML input element for search and the Enter key is pressed, an HTTP GET request should be made with the value provided in the HTML input element as the value to query parameter "title_search":::5:::', async () => {
    mockGetCookie()
    const mockFetchFunction = jest.fn().mockImplementation(url => {
      if (url === 'https://apis.ccbp.in/prime-deals') {
        return {
  ...
  it(':::RJSCP809S4_TEST_49:::When a category is clicked, an HTTP GET request should be made with the id of the category as the value to query parameter "category":::5:::', async () => {
    mockGetCookie()
    const mockFetchFunction = jest.fn().mockImplementation(url => {
      if (url === 'https://apis.ccbp.in/prime-deals') {
        return {
  ...
  it(':::RJSCP809S4_TEST_50:::When a rating is clicked, an HTTP GET request should be made with the id of the rating as the value to query parameter "rating":::5:::', async () => {
    mockGetCookie()
    const mockFetchFunction = jest.fn().mockImplementation(url => {
      if (url === 'https://apis.ccbp.in/prime-deals') {
        return {
  ...
  it(':::RJSCP809S4_TEST_51:::When all the filters in Products Route are applied and the "Clear Filters" button is clicked, then an HTTP GET request should be made to productsApiUrl with initial values of the query parameters:::5:::', async () => {
    mockGetCookie()
    const mockFetchFunction = jest.fn().mockImplementation(url => {
      if (url === 'https://apis.ccbp.in/prime-deals') {
        return {
  ...
  it(':::RJSCP809S4_TEST_52:::Each product card should be wrapped with the "Link" from react-router-dom:::5:::', async () => {
    mockGetCookie()

    renderWithBrowserRouter(<App />, {route: productsRoutePath})
    await waitFor(() => {
      expect(
        screen.getAllByText(/Front Load Machine/i).length,
  ...
  it(':::RJSCP809S4_TEST_53:::When the HTTP GET request made in Products Route is unsuccessful, then the page should consist of the HTML image element with alt attribute value as "products failure" and src as the given Failure view image URL:::5:::', async () => {
    mockGetCookie()
    server.use(
  ...
  it(':::RJSCP809S4_TEST_54:::When the HTTP GET request made to productsApiUrl returns products list as empty, then no products view should be displayed:::5:::', async () => {
    mockGetCookie()
    const mockFetchFunction = jest.fn().mockImplementation(url => {
      if (url === 'https://apis.ccbp.in/prime-deals') {
        return {
  ...
  it(':::RJSCP809S4_TEST_55:::When a Product card is clicked in Products Route, then the page should be navigated to the Product Item Details route with "/product-details/:id" in the URL path:::5:::', async () => {
    mockGetCookie()
