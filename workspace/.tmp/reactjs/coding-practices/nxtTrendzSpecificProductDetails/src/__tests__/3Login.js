...
describe(':::RJSCP809S4_TEST_SUITE_3:::Login Route tests', () => {
  beforeAll(() => {
    server.listen()
  })
  ...
  it(':::RJSCP809S4_TEST_32:::When "/login" is provided in the URL by an authenticated user, then the page should be navigated to Home Route and consists of an HTML image element with alt as "clothes that get you noticed" and src as given home image url:::5:::', async () => {
    mockGetCookie()
  ...
  it(':::RJSCP809S4_TEST_33:::When the Login is successful, then the history.replace() method should be called with the argument "/":::5:::', async () => {
