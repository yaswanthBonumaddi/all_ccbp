...
import { append, $, toggleClass, getDomNodePagePosition, removeClass, addClass, hasClass, hasParentWithClass, createStyleSheet, clearNode, addClasses, removeClasses } from '../../dom';
...
var AbstractTree = /** @class */ (function () {
    ...
    Object.defineProperty(AbstractTree.prototype, "onDidPin", {
        get: function () { return Event.map(this.view.onDidPin, asTreeEvent); },
        enumerable: true,
        configurable: true
    });
    ...
    AbstractTree.prototype.open = function (elements, browserEvent) {
        var _this = this;
        var indexes = elements.map(function (e) { return _this.model.getListIndex(e); }).filter(function (i) { return i >= 0; });
